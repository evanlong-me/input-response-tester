...
[![Star History Chart](https://api.star-history.com/svg?repos=evanlong/input-response-tester&type=Date)](https://star-history.com/#evanlong/input-response-tester&Date)

---

*专为游戏玩家和硬件爱好者设计的输入设备性能测试工具* 
